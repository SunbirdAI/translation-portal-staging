export const samplePhraseDict = {
  ...
  lug: [
    [
      ...
      [
        ...
        "Buli omu ye8etaaga eddembe okwoleka endowooza ze mu bwetaaye.",
      ],
    ],
  ],
  nyn: [
  ...
  swa: [
    [
      "Swahili",
      [
        "Wakati wa mlipuko wa virusi vya corona, watu walianza kutengeneza barakoa kutokana na nguo.",
        "Ni sababu zipi vijana wanatoa kwa kuacha shule?",
        "Saidia wanachama wahitaji katika jamii.",
        "Nini husababisha baadhi ya watoto kuto faulu vizuri shuleni?",
        "Wafanyakazi sasa wanaweza kuchagua kufanya kazi kutoka nyumbani au kuja ofisini.",
        "Benki zitakuwa wazi kwa saa sita tu kwa siku.",
        "Kila mtu anahitaji uhuru wa kuonyesha mawazo yake kwa uhuru.",
      ],
    ],
  ],
  kin: [
    [
      "Kinyarwanda",
      [
        "Mu gihe cy'icyorezo cya coronavirus, abantu batangiye gukora udupfukamunwa mu myenda.",
        "Ni izihe mpamvu urubyiruko rutanga zo guta ishuri?",
        "Fasha abanyamuryango bakeneye ubufasha muri sosiyete.",
        "Ni iki gitera bamwe mu bana gutsindwa neza mu ishuri?",
        "Abakozi bashobora guhitamo gukora kuva mu rugo cyangwa kuza ku biro.",
        "Amabanki azafungura amasaha atandatu gusa ku munsi.",
        "Buri wese akeneye ubwisanzure bwo kugaragaza ibitekerezo bye mu bwisanzure.",
      ],
    ],
  ],
  " ": [
    ...
    [
      ...
      [
        "Habari gani?",
        "Tunaweza kukutana lini na kuzungumza?",
    ...
    [
      ...
      [
        "Amakuru?",
        "Dushobora guhura ryari tukaganira?",
        "Nizere ko tuzongera kukubona vuba.",
      ],
    ],
  ],
  auto: [
